...
public class LagosJavaDevsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>
        implements DataLoadingSubject.DataLoadingCallbacks {

    private static final int TYPE_LAGOS_JAVA_DEV = 0;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        switch (viewType) {
            case TYPE_LAGOS_JAVA_DEV:
                return new LagosJavaDevsHolder(
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        switch (getItemViewType(position)) {
            case TYPE_LAGOS_JAVA_DEV:
                bindUserHolder((User) getItem(position), (LagosJavaDevsHolder) holder);
                break;
            case TYPE_LOADING_MORE:
    ...
    /* package */ static class LagosJavaDevsHolder extends RecyclerView.ViewHolder {
